...
function useFiglet(initialFont) {
    var _a;
    if (initialFont === void 0) { initialFont = 'Standard'; }
    var _b = react.useState(''), sourceText = _b[0], setSourceText = _b[1];
    var _c = react.useState(''), figletText = _c[0], setFigletText = _c[1];
    var _d = react.useState(initialFont), font = _d[0], setFont = _d[1];
    var _e = react.useState((_a = {}, _a[font] = false, _a)), fontLoadStatus = _e[0], setFontLoadStatus = _e[1];
    react.useEffect(function () {
        if (!fontLoadStatus[font]) {
            return;
        }
        nodeFiglet.text(sourceText, { font: font }, function (_, result) {
            if (result !== undefined) {
    ...
    react.useEffect(function () {
        ...
        Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require("figlet/importable-fonts/" + font + ".js")); }).then(function (module) {
            nodeFiglet.parseFont(font, module.default);
            setFontLoadStatus(function (prev) {
                var _a;
                return Object.assign({}, prev, (_a = {}, _a[font] = true, _a));
            });
        });
    }, [font]);
