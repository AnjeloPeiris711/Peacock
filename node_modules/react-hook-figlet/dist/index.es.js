...
function useFiglet(initialFont) {
    ...
    var _b = useState(''), sourceText = _b[0], setSourceText = _b[1];
    var _c = useState(''), figletText = _c[0], setFigletText = _c[1];
    var _d = useState(initialFont), font = _d[0], setFont = _d[1];
    var _e = useState((_a = {}, _a[font] = false, _a)), fontLoadStatus = _e[0], setFontLoadStatus = _e[1];
    useEffect(function () {
    ...
    useEffect(function () {
        ...
        import("figlet/importable-fonts/" + font + ".js").then(function (module) {
